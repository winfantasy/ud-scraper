    ...
    if (isOverUnder) {
      ...
      for (const market of markets) {
        ...
        props.push({
          ...
          stat_type: statType,
          stat_display: statType,
          stat_value: isWinnerMarket ? null : (lineFromTicker || yesBid),
          over_price: centsToAmerican(yesBid),
          under_price: isWinnerMarket ? null : centsToAmerican(100 - yesAsk),
          over_decimal: yesBid ? (yesBid / 100) : null,
          under_decimal: isWinnerMarket ? null : ((100 - yesAsk) > 0 ? ((100 - yesAsk) / 100) : null),
